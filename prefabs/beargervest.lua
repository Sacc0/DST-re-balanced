...
GLOBAL.TUNING.BEARGERVEST_PERISHTIME = total_day_time * 15
...
local function onequip(inst, owner)
    ...
    if owner.components.hunger ~= nil then
        owner.components.hunger.burnratemodifiers:SetModifier(inst, GLOBAL.TUNING.ARMORBEARGER_SLOW_HUNGER)
    end
